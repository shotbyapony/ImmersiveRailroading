...
public class Inspection extends BuilderBase {
	protected float angle;
	public int mainX;
	public int mainZ;
	protected HashSet<Pair<Integer, Integer>> positions;
	
	public Inspection(RailInfo info, BlockPos pos) {
		this(info, pos, false);
	}

	public Inspection(RailInfo info, BlockPos pos, boolean endOfTrack) {
		super(info, pos);
